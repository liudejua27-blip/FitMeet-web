...
declare -A COLUMNS=(
  ...
  [agent_approval_requests]="actionType reason createdBy agentTaskId relatedSocialRequestId relatedCandidateId relatedActivityId"
  [agent_action_logs]="ownerUserId actionType actionStatus riskLevel agentTaskId relatedActivityId relatedSocialRequestId relatedCandidateId payload eventType conversationId messageId status metadata"
