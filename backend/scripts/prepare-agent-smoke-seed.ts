...
import { LifeGraphField } from '../src/life-graph/entities/life-graph-field.entity';
import { LifeGraphProfile } from '../src/life-graph/entities/life-graph-profile.entity';
import {
  LifeGraphFieldCategory,
  LifeGraphFieldSource,
  LifeGraphSignalType,
} from '../src/life-graph/life-graph.enums';
...
const ownerEmail = normalizeEmail(
  process.env.AGENT_SMOKE_EMAIL ?? 'agent-smoke-owner@socialworld.world',
);
...
const candidates: SeedPerson[] = [
  {
    email: 'agent-smoke-candidate-lin@socialworld.world',
    name: '林一舟',
    gender: '男',
    age: 29,
    color: '#16B87A',
  ...
  {
    email: 'agent-smoke-candidate-xia@socialworld.world',
    name: '夏禾',
    gender: '女',
    age: 27,
    color: '#6554FF',
  ...
  {
    email: 'agent-smoke-candidate-chen@socialworld.world',
    name: '陈砚',
    gender: '男',
    age: 31,
    color: '#F0C85A',
