...
export enum AgentTaskEventType {
  ...
  SocialAgentMessageUser = 'social_agent.message.user',
  SocialAgentMessageAssistant = 'social_agent.message.assistant',
  SocialAgentCandidatesReturned = 'social_agent.candidates.returned',
