...
export class AddSocialAgentRuntime1773100000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_tasks_owner_status_updated" ON "agent_runtime_tasks" ("ownerUserId", "status", "updatedAt")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_tasks_agent_status" ON "agent_runtime_tasks" ("agentConnectionId", "status")`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX IF NOT EXISTS "uniq_agent_runtime_tasks_idempotency_key" ON "agent_runtime_tasks" ("idempotencyKey") WHERE "idempotencyKey" IS NOT NULL`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_goals_task_status" ON "agent_runtime_goals" ("taskId", "status")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_goals_owner_status" ON "agent_runtime_goals" ("ownerUserId", "status")`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX IF NOT EXISTS "uniq_agent_runtime_plans_task_version" ON "agent_runtime_plans" ("taskId", "version")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_plans_task_status" ON "agent_runtime_plans" ("taskId", "status")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_plans_owner_status" ON "agent_runtime_plans" ("ownerUserId", "status")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_steps_task_order" ON "agent_runtime_steps" ("taskId", "stepOrder")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_steps_plan_status" ON "agent_runtime_steps" ("planId", "status")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_steps_owner_status" ON "agent_runtime_steps" ("ownerUserId", "status")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_steps_approval" ON "agent_runtime_steps" ("approvalRequestId")`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX IF NOT EXISTS "uniq_agent_runtime_steps_idempotency_key" ON "agent_runtime_steps" ("idempotencyKey") WHERE "idempotencyKey" IS NOT NULL`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_tool_calls_task_created" ON "agent_runtime_tool_calls" ("taskId", "createdAt")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_tool_calls_step_created" ON "agent_runtime_tool_calls" ("stepId", "createdAt")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_tool_calls_owner_status" ON "agent_runtime_tool_calls" ("ownerUserId", "status")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_tool_calls_tool_status" ON "agent_runtime_tool_calls" ("toolName", "status")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_tool_calls_approval" ON "agent_runtime_tool_calls" ("approvalRequestId")`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX IF NOT EXISTS "uniq_agent_runtime_tool_calls_idempotency_key" ON "agent_runtime_tool_calls" ("idempotencyKey") WHERE "idempotencyKey" IS NOT NULL`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_results_task_created" ON "agent_runtime_results" ("taskId", "createdAt")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_results_owner_type_created" ON "agent_runtime_results" ("ownerUserId", "resultType", "createdAt")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_results_target_user" ON "agent_runtime_results" ("targetUserId")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_results_related_social_request" ON "agent_runtime_results" ("relatedSocialRequestId")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_results_related_candidate" ON "agent_runtime_results" ("relatedCandidateId")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_results_related_activity" ON "agent_runtime_results" ("relatedActivityId")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_logs_task_created" ON "agent_runtime_logs" ("taskId", "createdAt")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_logs_owner_event_created" ON "agent_runtime_logs" ("ownerUserId", "eventType", "createdAt")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_logs_level_created" ON "agent_runtime_logs" ("level", "createdAt")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_agent_runtime_logs_tool_call" ON "agent_runtime_logs" ("toolCallId")`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_logs_tool_call"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_logs_level_created"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_logs_owner_event_created"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_logs_task_created"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_results_related_activity"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_results_related_candidate"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_results_related_social_request"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_results_target_user"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_results_owner_type_created"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_results_task_created"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "uniq_agent_runtime_tool_calls_idempotency_key"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_tool_calls_approval"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_tool_calls_tool_status"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_tool_calls_owner_status"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_tool_calls_step_created"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_tool_calls_task_created"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "uniq_agent_runtime_steps_idempotency_key"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_steps_approval"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_steps_owner_status"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_steps_plan_status"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_steps_task_order"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_plans_owner_status"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_plans_task_status"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "uniq_agent_runtime_plans_task_version"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_goals_owner_status"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_goals_task_status"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "uniq_agent_runtime_tasks_idempotency_key"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_tasks_agent_status"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "idx_agent_runtime_tasks_owner_status_updated"`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE IF EXISTS "agent_runtime_log_level_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE IF EXISTS "agent_runtime_result_status_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE IF EXISTS "agent_runtime_tool_call_status_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE IF EXISTS "agent_runtime_step_status_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE IF EXISTS "agent_runtime_plan_status_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE IF EXISTS "agent_runtime_goal_status_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE IF EXISTS "agent_runtime_risk_level_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE IF EXISTS "agent_runtime_task_status_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE IF EXISTS "agent_runtime_permission_mode_enum"`,
    );
  }
}
