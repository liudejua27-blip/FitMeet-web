...
const file = 'c:/Users/86152/fitness-app/frontend/src/pages/AiMatchPage.tsx';
const lines = readFileSync(file, 'utf8').split('\n');

// Keep first 236 lines (head), remove old dark content
const head = lines.slice(0, 236).join('\n');
